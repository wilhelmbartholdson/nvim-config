return {
  {
    ...
    event = {
      ...
      "BufReadPre " .. vim.fn.expand "~" .. "/desktop/universitetet/*.md",
      "BufNewFile " .. vim.fn.expand "~" .. "/desktop/universitetet/*.md",

      "BufReadPre " .. vim.fn.expand "~" .. "/desktop/eiravault/*.md",
    ...
    opts = {
      workspaces = {
        {
          name = "uni",
          path = "~/desktop/universitetet",
        },
        {
          name = "eira",
          path = "~/desktop/eiravault",
        },
      },
      ...
      ui = {
        ...
        checkboxes = {
          ...
          ["k"] = { char = "􁠲", hl_group = "ObsidianCheckKey" },
        ...
        hl_groups = {
          ...
          ObsidianCheckKey = { bold = true, bg = "#FFC000" },
        },
      },
